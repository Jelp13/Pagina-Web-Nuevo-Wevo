 ...
 * 33 departamentos · 1.122 municipios
 *
 * Para actualizar: editar las listas de municipios por departamento.
 */
...
export const COLOMBIA_GEO: Record<string, string[]> = {
  ...
  Antioquia: [
    ...
    'Argelia', 'Armenia', 'Barbosa', 'Bello', 'Betania', 'Betulia', 'Bolívar',
    ...
    'Concepción', 'Concordia', 'Copacabana', 'Dabeiba', 'Don Matías', 'Ebéjico',
    ...
    'Itagüí', 'Ituango', 'Jardín', 'Jericó', 'La Ceja del Tambo',
  ...
  Boyacá: [
    ...
    'Nobsa', 'Nuevo Colón', 'Oicatá', 'Otanche', 'Paipa', 'Pajarito',
    ...
    'Tota', 'Tunja', 'Turmequé', 'Tuta', 'Tutazá', 'Úmbita', 'Ventaquemada',
  ...
  Chocó: [
    ...
    'Nuquí', 'Quibdó', 'Río Iro', 'Río Quito', 'Riosucio',
  ...
  Nariño: [
    ...
    'Cuaspúd', 'Cumbal', 'Cumbitara', 'El Charco', 'El Peñol', 'El Rosario',
  ...
  'Norte de Santander': [
    'Ábrego', 'Arboledas', 'Bochalema', 'Bucarasica', 'Cácota', 'Cachirá',
  ...
  Sucre: [
    ...
    'Santiago de Tolú', 'Sincé', 'Sincelejo', 'Sucre', 'Tolú Viejo',
  ],
  Tolima: [
...
export const DEPARTAMENTOS: string[] = Object.keys(COLOMBIA_GEO).sort((a, b) =>
  a.localeCompare(b, 'es')
);

/** Retorna los municipios de un departamento, o array vacío si no existe */
export function getMunicipios(departamento: string): string[] {
  return COLOMBIA_GEO[departamento] ?? [];
}
