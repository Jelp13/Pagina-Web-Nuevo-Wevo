      ...
      <div className="mx-auto flex max-w-[1180px] items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="hidden rounded-full bg-emerald-500 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-600 transition-colors shadow-lg md:inline-flex"
        ...
        <div className="border-t border-cyan-400/10 bg-slate-950/95 px-6 py-4 text-sm text-slate-200 md:hidden">
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block rounded-2xl bg-emerald-500 px-4 py-3 text-center text-sm font-semibold text-white hover:bg-emerald-600"
            >
              Asesoría
            </a>
          </div>
