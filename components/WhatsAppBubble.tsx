...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-10 right-10 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-500 shadow-lg hover:bg-emerald-600 hover:scale-110 transition-all duration-200"
    >
